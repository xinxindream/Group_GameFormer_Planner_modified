...
# def get_filter_parameters(num_scenarios_per_type=20, limit_total_scenarios=None, shuffle=True, scenario_tokens=None, timestamp_threshold_s=None):
def get_filter_parameters(num_scenarios_per_type=20, scenario_type=None, limit_total_scenarios=None, shuffle=True, scenario_tokens=None, timestamp_threshold_s=None):
    # nuplan challenge
    # scenario_types = [
    #     'starting_left_turn',
    #     'starting_right_turn',
