...
if __name__ == "__main__":
    ...
    parser.add_argument('--total_scenarios', default=4000000, help='limit total number of scenarios')
    ...
    parser.add_argument('--config_path', type=str,
                        default='/home/xingchen24/code/deeplearning/imitation_learning/PlanTF/planTF/config/scenario_filter/val14.yaml',
                        help='`config path')
    ...
    for scenario_type in conf['scenario_types']:
        # get scenarios
        ...
        scenario_filter = ScenarioFilter(*get_filter_parameters(args.scenarios_per_type, scenario_type_list, args.total_scenarios, args.shuffle_scenarios))
        worker = SingleMachineParallelExecutor(use_process_pool=True)
        print('counting ', scenario_type)
        scenarios = builder.get_scenarios(scenario_filter, worker)
        print(f"{scenario_type} Total number of scenarios: {len(scenarios)}")
