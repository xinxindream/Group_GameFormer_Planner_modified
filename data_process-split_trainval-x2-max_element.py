...
class DataProcessor(object):
    def __init__(self, scenarios):
        ...
        self._max_points = {'LANE': 80, 'ROUTE_LANES': 80, 'CROSSWALK': 30} # maximum number of points per feature to extract per feature layer.
        self._radius = 120 # [m] query radius scope relative to the current pose.
...
if __name__ == "__main__":
    ...
    parser.add_argument('--total_scenarios', default=3000000, help='limit total number of scenarios')
    parser.add_argument('--val_ratio', type=float, default=0.08, help='ratio of val_scenarios')
    ...
    os.makedirs(args.save_path+'_val', exist_ok=True)
    ...
    processor_val = DataProcessor(selected_val_scenarios)
    processor_val.work(args.save_path+'_val', debug=args.debug)
