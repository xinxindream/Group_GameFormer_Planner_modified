...
class gameformer_planner(object):
    def __init__(self, model_path, device=None):
        ...
        self._original_route_lane_data_x_path = "/home/xingchen24/code/deeplearning/imitation_learning/route_lane/original_route_lane_data_x.npz"
        self._original_route_lane_data_y_path = "/home/xingchen24/code/deeplearning/imitation_learning/route_lane/original_route_lane_data_y.npz"
        self._shift_route_lane_data_x_path = "/home/xingchen24/code/deeplearning/imitation_learning/route_lane/shift_route_lane_data_x.npz"
        self._shift_route_lane_data_y_path = "/home/xingchen24/code/deeplearning/imitation_learning/route_lane/shift_route_lane_data_y.npz"
    ...
    def execute_planning(self, agents_past_queue, ego_past_queue, map_lanes, route_lanes):
        ...
        ego_state = StateSE2(x=self._ego_past_queue[-1].vehicle_set.vehicles[0].state.vec_position.x,
                             y=self._ego_past_queue[-1].vehicle_set.vehicles[0].state.vec_position.y,
        ...
        distances = cdist(self._original_route_lane_data_xy,
                          np.array([ego_state.x, ego_state.y]).reshape(
                              1, -1))
        ...
        if (min_index < 0) | (max_index > self._original_route_lane_data_xy.shape[0] - 1):
            print(f"无可用车道线")
            return
