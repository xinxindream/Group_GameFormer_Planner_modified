...
def train_epoch(data_loader, model, optimizer):
    ...
    with tqdm(data_loader, desc="Training", unit="batch") as data_epoch:
        for batch in data_epoch:
            ...
            ego_multi_plan, probability, prediction = model(inputs)
            ...
            # add interacyion loss
            inter_loss = interaction_loss(best_traj[..., :2], prediction, neighbors_future_valid)
            loss = ego_reg_loss + ego_cls_loss + agent_reg_loss + 0.5 * inter_loss
        ...
        for batch in data_epoch:
           # prepare data
            ...
            with torch.no_grad():
                ...
                # add interacyion loss
                inter_loss = interaction_loss(ego_multi_plan, prediction, neighbors_valid)
                loss = ego_reg_loss + ego_cls_loss + agent_reg_loss + 0.5 * inter_loss
...
if __name__ == "__main__":
    ...
    parser.add_argument('--name', type=str, help='log name (default: "Exp1")', default="Exp1-plantf-1211-xiaoba-lre-4")
